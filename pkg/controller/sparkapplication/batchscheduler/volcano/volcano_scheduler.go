...
func (v *VolcanoBatchScheduler) OnSubmitSparkApplication(app *v1beta1.SparkApplication) error {
...
func (v *VolcanoBatchScheduler) syncPodGroupForClientAPP(app *v1beta1.SparkApplication) error {
...
func (v *VolcanoBatchScheduler) syncPodGroupForClusterAPP(app *v1beta1.SparkApplication) error {
...
func (v *VolcanoBatchScheduler) OnSparkDriverPodScheduled(app *v1beta1.SparkApplication) error {
	// Update PodGroup MinMember if required
	if app.Spec.Mode == v1beta1.ClusterMode {
		return v.syncPodGroup(app, 1 + *(app.Spec.Executor.Instances))
	}
	return nil
}
...
func New(config *rest.Config) batchscheduler.BatchScheduler {
