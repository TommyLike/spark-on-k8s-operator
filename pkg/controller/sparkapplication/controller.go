...
type Controller struct {
	...
	batchScheduler    batchscheduler.BatchScheduler
}
...
func NewController(
	...
	namespace string,
	ingressURLFormat string,
	batchscheduler batchscheduler.BatchScheduler) *Controller {
...
func (c *Controller) getAndUpdateDriverState(app *v1beta1.SparkApplication) error {
	...
	if driverPod.Status.Phase == apiv1.PodRunning {
		err := c.batchScheduler.OnSparkDriverPodScheduled(app)
		if err != nil {
...
func (c *Controller) submitSparkApplication(app *v1beta1.SparkApplication) *v1beta1.SparkApplication {
	...
	if c.scheduleViaBatchScheduler(app) {
		err := c.batchScheduler.OnSubmitSparkApplication(app)
		if err != nil {
